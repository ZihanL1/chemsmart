...
def visualize(
    ...
    **kwargs,
    ...
    """CLI subcommand for running automatic PyMOL visualization and save as PSE
    file.
    Example usage:
    ...
    Example usage:
    chemsmart run mol -f 'structure_file' visualize -G '233,468-512' -G
    '308,397-414,416-423'
    """
    ...
    # raise error if -G/-C/-sc/-st or new_color_* is provided when --hybrid is
    # false
    hybrid_only_opts = [
        "groups",
        "colors",
