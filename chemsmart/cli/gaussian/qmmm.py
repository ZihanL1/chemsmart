"""Helper functions and decorators for QMMM job support across Gaussian
commands.
"""
...
def create_qmmm_subcommand(parent_command):
    ...
    Args:
        parent_command: The Click group command to attach the qmmm subcommand
        to
    ...
    def qmmm(
        ...
        **kwargs,
        ...
        # Subcommand value wins over parent; fall back to parent then default
        # False
        ...
        # 2. Merge parent job settings (to inherit modred, custom_solvent,
        # etc.)
        ...
        if parent_settings is not None:
            ...
            # Define which attributes should ALWAYS be inherited from parent
            # (if not None in parent)
            # These are job-specific attributes that come from the parent
            # command or CLI
        ...
        # Step 3: Apply CLI options to qmmm_settings (these override project
        # and parent)
