...
class TestGenGenECPBasisDetermination:
    ...
    def test_determine_basis_keyword_no_heavy_elements(self):
        ...
        # Determine basis should use light elements since no heavy elements
        # present
    ...
    def test_determine_basis_keyword_non_gen_basis(self):
        ...
        # Determine basis should return original basis since it's not
        # gen/genecp
        determined_basis = settings.determine_basis_keyword(br_mol)
...
class TestGenECPReplacementInRoute:
    """Test that gen/genecp replacement in route strings doesn't affect other
    keywords.
    """

    def test_gen_replacement_does_not_affect_noeigentest(self):
        """Test that 'gen' in 'noeigentest' is not replaced, and case mode
        behaves correctly.
        """
        import re
        ...
        # Route strings with lowercase 'gen' (replacement should work in BOTH
        # modes)
        route_strings = [
    ...
    def test_gen_to_genecp_replacement(self):
        """Test replacing 'gen' with 'genecp' in route strings for both case
        modes.
        """
        import re
    ...
    def test_replacement_with_various_delimiters(self):
        """Test that replacement works correctly with various delimiters, in
        both case modes.
        """
        from chemsmart.utils.io import replace_word
        ...
        # Should not replace "gen" when it is part of another word (boundary
        # test)
        # NOTE: this string actually *contains* a standalone "gen" at the end,
        # so it SHOULD replace that one.
