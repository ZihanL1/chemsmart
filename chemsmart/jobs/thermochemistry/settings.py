...
class ThermochemistryJobSettings:
    ...
    Attributes:
        ...
        concentration (float | None): Concentration for solution-phase
        corrections.
        ...
        check_imaginary_frequencies (bool): Validate absence of imaginary
        modes.
    ...
    def __init__(
        ...
        Args:
            ...
            write_header (bool): Whether to write header to output file
            (default: True)
        """
