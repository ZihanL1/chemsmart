...
class ORCAOutFolder(BaseFolder):
    ...
    This class provides utilities for managing collections of ORCA output
    files,
    including calculation statistics, runtime analysis, and resource usage
    tracking.
    """
    ...
    def total_service_units(self):
        """
        Calculate total computational service units used across all output
        files.
