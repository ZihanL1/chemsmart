...
def nci(
    ...
    **kwargs,
    ...
    """CLI subcommand for generating automatic PyMOL NCI plot and save as PSE
    file.
    Example usage:
    ...
    Note that the phenyldioxazolone_nci-dens.cube and
    phenyldioxazolone_nci-grad.cube
