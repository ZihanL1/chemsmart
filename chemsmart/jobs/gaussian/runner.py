...
class GaussianJobRunner(JobRunner):
    ...
    Attributes:
        ...
        executable (GaussianExecutable): Executable configuration for the
        server.
...
class FakeGaussianJobRunner(GaussianJobRunner):
    ...
    Attributes:
        ...
        job_outputfile (str): Full path to the output `.log` file (created by
        fake run).
        job_chkfile (str): Full path to the checkpoint `.chk` file (path
        assigned).
