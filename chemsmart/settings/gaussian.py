...
class GaussianProjectSettings(RegistryMixin):
    ...
    def main_settings(self):
        ...
        Returns:
            GaussianJobSettings: Default job settings with functional and basis
            set.
        """
    ...
    def opt_settings(self):
        ...
        Returns:
            GaussianJobSettings: Settings configured for structure
            optimization.
        """
    ...
    def irc_settings(self):
        ...
        Returns:
            GaussianIRCJobSettings: IRC-specific settings with frequency
            disabled.
        """
        settings = self.main_settings().copy()
    ...
    def scan_settings(self):
        ...
        Returns:
            GaussianJobSettings: Settings for coordinate scanning with
            frequency disabled.
        """
        settings = self.main_settings().copy()
    ...
    def nci_settings(self):
        ...
        Returns:
            GaussianJobSettings: Settings for NCI analysis with frequency
            disabled.
        """
        settings = self.main_settings().copy()
    ...
    def wbi_settings(self):
        ...
        Returns:
            GaussianJobSettings: Settings for WBI analysis with frequency
            disabled.
        """
        settings = self.main_settings().copy()
    ...
    def from_project(cls, project):
        ...
        Raises:
            FileNotFoundError: If no configuration is found for the specified
            project.
        """
    ...
    def _from_projects_manager(cls, manager):
        ...
        Returns:
            YamlGaussianProjectSettings or None: YAML-based settings instance
...
class YamlGaussianProjectSettingsBuilder:
    ...
    def _project_settings_for_job(self, jobtype):
        ...
        Returns:
            GaussianJobSettings: Configured settings for the specified job
            type.
