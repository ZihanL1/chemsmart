...
class ORCAInputWriter(InputWriter):
    ...
    Attributes:
        ...
        settings (ORCAJobSettings): Settings used to generate the route and
        blocks.
    ...
    def _write_solvent_block(self, f):
        ...
        # %cpcm block, %cosmo block, or %smd block that cannot be capture by
        # route
        pass
    ...
    def _write_mdci_block(self, f):
        ...
        if mdci_cutoff is not None:
            ...
            # check that mdci_cutoff is one of the allowed values: ["loose",
            # "normal", "tight"]
            ...
            if mdci_density is not None:
                # check that mdci_density is one of the allowed values:
    ...
    def _write_modred_if_list(f, modred):
        ...
        # 'self.modred' as list of lists, or a single list if only one fixed
        # constraint
    ...
    def _write_hessian_block_for_ts(self, f):
        ...
        """Hybrid Hessian for speed up of TS search: TS mode is complicated and
        delocalized,
        e.g. in a concerted proton transfer reaction, can use hybrid Hessian to
        calc
    ...
    def _write_charge_and_multiplicity(self, f):
        ...
        # Common names across settings: charge_qm, charge_intermediate,
        # charge_total
