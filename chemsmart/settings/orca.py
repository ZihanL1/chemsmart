...
# This is not due to Python 3.9 itself, but type checking rules enforced by
# tools
...
class ORCAProjectSettings(RegistryMixin):
    ...
    def main_settings(self):
        ...
        Returns:
            ORCAJobSettings: Default ORCA job settings with functional and
            basis set.
        """
    ...
    def ts_settings(self):
        ...
        Returns:
            ORCATSJobSettings: Settings configured for transition state
            optimization.
        """
        settings = self.main_settings().copy()
    ...
    def irc_settings(self):
        ...
        from transition states to reactants and products. Frequency
        calculations
    ...
    def scan_settings(self):
        ...
        Returns:
            ORCAJobSettings: Settings configured for coordinate scan
            calculations.
        """
        settings = self.main_settings().copy()
    ...
    def nci_settings(self):
        ...
        Creates settings for NCI (Non-Covalent Interaction) analysis
        calculations
    ...
    def sp_settings(self):
        ...
        Creates settings for single point calculations at higher level of
        theory
    ...
    def from_project(cls, project):
        ...
        Returns:
            YamlORCAProjectSettings: Configured YAML-based project settings
            instance.
    ...
    def _from_projects_manager(cls, manager):
        ...
        Internal method for loading project settings through a manager
        instance.
        ...
        Returns:
            YamlORCAProjectSettings or None: YAML-based loaded settings or None
            if loading fails.
        """
        try:
...
class YamlORCAProjectSettingsBuilder:
    ...
    def _project_settings_for_job(self, jobtype):
        ...
        Returns:
            ORCAJobSettings or ORCAIRCJobSettings or ORCATSJobSettings:
            Configured
                settings for the specified job type. Returns ORCAIRCJobSettings
                for
                IRC jobs, ORCATSJobSettings for TS jobs, and ORCAJobSettings
                for
                all other job types.
