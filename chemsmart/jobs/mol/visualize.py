...
class PyMOLHybridVisualizationJob(PyMOLVisualizationJob):
    ...
    - Override default atomic colors (C, N, O, S, P) with user-specified RGB
    values.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            groups (Iterable): Sequence of group specifications (parsed from
            CLI).
            colors (Iterable, optional): Sequence of colors corresponding to
            groups.
            stick_radius (float, optional): Stick radius for rendering.
            surface_color (str or tuple, optional): Surface color override.
            surface_transparency (float, optional): Surface transparency
            override.
