...
class Executable(RegistryMixin):
    """
    Abstract base class for obtaining program executable paths and
    configurations.
    ...
    server YAML files and handles environment setup including conda
    environments,
...
class GaussianExecutable(Executable):
    ...
    def __init__(self, executable_folder=None, **kwargs):
        ...
        Args:
            executable_folder (str, optional): Path to Gaussian executable
            directory.
    ...
    def get_executable(self):
        ...
        Returns:
            str or None: Full path to g16 executable if executable_folder is
            set,
                        None otherwise.
        """
...
class ORCAExecutable(Executable):
    ...
    def __init__(self, executable_folder=None, **kwargs):
        ...
        Args:
            executable_folder (str, optional): Path to ORCA executable
            directory.
            **kwargs: Additional arguments passed to parent Executable class.
        """
        super().__init__(executable_folder=executable_folder, **kwargs)
    ...
    def get_executable(self):
        ...
        Returns:
            str or None: Full path to orca executable if executable_folder is
            set,
                        None otherwise.
        """
        if self.executable_folder is not None:
...
class NCIPLOTExecutable(Executable):
    ...
    def __init__(self, executable_folder=None, **kwargs):
        ...
        Args:
            executable_folder (str, optional): Path to NCIPLOT executable
            directory.
            **kwargs: Additional arguments passed to parent Executable class.
        """
        super().__init__(executable_folder=executable_folder, **kwargs)
    ...
    def get_executable(self):
        ...
        Returns:
            str or None: Full path to nciplot executable if executable_folder
            is set,
                        None otherwise.
        """
        if self.executable_folder is not None:
