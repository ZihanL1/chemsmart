...
def align(
    ...
    **kwargs,
    ...
    In align, the -t option uses file extensions like log, xyz, inp, instead of
    task types like Gaussian or ORCA to ensure structural visualization for
    multiple file types.
    ...
    if directory:
        ...
        if len(filenames) == 1:
            ...
            # Multiple files: use the same per-file processing as directory
            # mode
            process_files_with_per_file_indexing(
