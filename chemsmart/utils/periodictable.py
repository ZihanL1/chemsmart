...
class PeriodicTable:
    ...
    def to_element(self, element_str):
        ...
        # Fall back to legacy behavior if nothing matched (will likely raise
        # later)
        return (
            cleaned.upper()
            if len(cleaned) == 1
    ...
    def sorted_periodic_table_list(self, list_of_elements):
        ...
        Args:
            list_of_elements (list[str]): Element symbols to sort
            (case-sensitive;
    ...
    def to_atomic_number(self, symbol):
        ...
        Args:
            symbol (str): Element symbol (e.g., 'H', 'He', 'Li').
            Case-sensitive;
