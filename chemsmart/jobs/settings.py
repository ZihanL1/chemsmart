...
class MolecularJobSettings:
    """Common base job settings for molecular systems using Gaussian and ORCA
    jobs.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if custom_solvent is not None:
            ...
            # check that the last line of custom_solvent is empty, if not, add
            # an empty line
    ...
    def update_solvent(self, solvent_model=None, solvent_id=None):
        ...
        Solvent models available: ['pcm', 'iefpcm', 'cpcm', 'smd', 'dipole',
        'ipcm', 'scipcm'].
        """
...
def read_molecular_job_yaml(filename, program="gaussian"):
    ...
    if gas_config is None:
        # no settings for gas phase; using implicit solvation model for all
        # jobs
